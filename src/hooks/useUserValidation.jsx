...
const useUserValidation = (initialFormState) => {
    ...
    const validateField = (name, value) => {
        ...
        // שדות שאינם חובה
        const optionalFields = ['middle', 'url', 'alt', 'state', 'isBusiness'];

        const [mainKey, subKey] = name.split('.');
        const fieldName = subKey || mainKey;

        if (optionalFields.includes(fieldName) || optionalFields.includes(mainKey)) {
            return '';
        }
